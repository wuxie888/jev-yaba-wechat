...
当前为 **0.2.2 开发预览版**，已合入截至 2026-09-22 本次同步时的读屏优化、启动预热和提前判断更新。已完成本机打包启动、录屏授权、真实微信文字读取和 GPT Responses 真实请求验证。Jev 认证与完整生成/排序/填入流程仍待验收。详见 [本机测试记录](docs/LOCAL_TESTING.md)。
